...
#in
{
  ...
  services.xservice.displayManager.defaultSession = "plasma";
  services.xservice.displayManager.sddm.wayland.enable = true;
  services.xservice.desktopManager.plasma5.enable = true;
